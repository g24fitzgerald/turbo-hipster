...
class page_two(page_one):
    ...
    def widgets(self):
        # Titles 
        self.title3 = Label(self, text = "Contortion Program", font = t_font)
        self.title3.grid(row = 0, column = 1, columnspan = 3)
        self.title4 = Label(self, text = "Do you have injuries in any of the following areas?", font = ("Helvetica", 24), pady = 8)
        self.title4.grid(row = 1, column = 1, columnspan = 3)
